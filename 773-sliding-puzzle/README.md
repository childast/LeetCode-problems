...
<pre style="position: relative;"><strong>Input:</strong> board = [[1,2,3],[4,0,5]]
...
<pre style="position: relative;"><strong>Input:</strong> board = [[1,2,3],[5,4,0]]
<strong>Output:</strong> -1
...
<pre style="position: relative;"><strong>Input:</strong> board = [[4,1,2],[5,0,3]]
